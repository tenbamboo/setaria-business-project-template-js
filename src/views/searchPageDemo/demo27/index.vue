<template>
  <div>
    <!--
    通过本Demo可了解控制表单必填 非必填

    在有的场景下，我们需要通过某些前置数据，来控制接下来的数据是否必填、非必填

    这时，我们可以使用框架自带的 addRequired removeRequired
    比如以下场景：
    当用户新增数据时，
...
<script setup name="searchPageDemo27">
  import { getSchema, removeRequired, addRequired } from "setaria-business-framework";
